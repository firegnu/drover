...
# ============================================================ 渲染
CSS = """
:root{--s0:#222429;--rail:#1f2126;--s1:#26282d;--s2:#2e3036;--s3:#35383e;--mast:#16181d;--line:#34363c;--line-soft:#2d2f35;--line-strong:#45474d;
--t1:#f2f0eb;--t2:#e6e4df;--t3:#b1afa9;--t4:#8f8d88;--t5:#6f7176;
...
.mast{display:flex;align-items:center;gap:20px;padding:0 24px;height:46px;background:var(--mast);color:var(--t2);border-bottom:1px solid #000;box-shadow:0 1px 0 var(--line-soft);position:sticky;top:0;z-index:5}
.mast .brand{font-weight:700;font-size:var(--fs4);letter-spacing:.01em;color:#fff}
.mast .agents{display:flex;align-items:center;gap:8px;font-size:var(--fs2);flex-wrap:wrap}.mast .ag{padding:0 11px;line-height:24px;border:1px solid #3a3c43;border-radius:999px;background:#21232a}.mast .ag b{font-weight:600;margin-right:6px}
...
.hp{margin-left:auto;display:inline-flex;align-items:center;gap:7px;font:var(--fs2) inherit;color:var(--t3);background:#21232a;border:1px solid #3a3c43;border-radius:999px;padding:0 11px 0 9px;line-height:24px;cursor:pointer;font-variant-numeric:tabular-nums}
