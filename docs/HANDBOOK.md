...
html,body{color-scheme:dark;margin:0;padding:0;background:var(--s0);color:var(--t2);font-family:-apple-system,BlinkMacSystemFont,"PingFang SC","Hiragino Sans GB","Helvetica Neue","Microsoft YaHei",sans-serif;font-size:var(--fs3);line-height:1.55;-webkit-font-smoothing:antialiased}
...
.tri{display:inline-block;transition:transform .1s;color:var(--t4);font-size:10px}
...
.banner{background:#2c2028;border-bottom:1px solid #4d2636;box-shadow:inset 3px 0 0 var(--red);padding:12px 24px;display:flex;gap:24px;align-items:baseline}
.banner .t{font-weight:700;color:var(--red-t);font-size:var(--fs4);flex:none}
.banner .items{display:flex;flex-direction:column;gap:6px;min-width:0}
...
.banner a b{font-weight:600;flex:none;font-size:var(--fs1);color:#f7d4dc;background:#4d2636;border-radius:var(--r1);padding:0 7px;line-height:18px}.banner a .age{color:#d98aa0}.banner a .arr{color:var(--red)}
...
.rbd-b .rbd-ok{background:var(--blue);border-color:var(--blue);color:#fff}.rbd-b .rbd-ok:disabled{opacity:.6;cursor:default}
...
.rbe-title:focus,.rbe-flow:focus,.rbe-body:focus{border-color:var(--blue)}.rbe-title{font-size:var(--fs4);font-weight:600}.rbe-flow{width:max-content}
...
.drawer .dct{overflow-y:auto;padding:18px 22px 48px}
.dtt{font-size:var(--fs4);font-weight:700;color:var(--t1);letter-spacing:-.01em}
.dsub{margin-top:8px;display:flex;gap:6px 12px;flex-wrap:wrap;align-items:center;font-size:var(--fs2);color:var(--t4)}.dsub code{color:var(--t3)}.dst{font-weight:600;color:var(--t2)}
.dsrc{margin-top:6px;font-size:var(--fs1);color:var(--t4)}
.dbody{margin-top:16px;border-top:1px solid var(--line);padding-top:14px;font-size:var(--fs3);line-height:1.7;color:var(--t2)}
.dbody .dh4{margin:12px 0 4px;font-weight:700;color:var(--t1)}.dbody .dli{padding-left:16px;position:relative}.dbody .dli::before{content:"·";position:absolute;left:5px;color:var(--t4)}.dbody .dgap{height:8px}
...
details.proc{margin-top:8px}details.proc>summary{color:var(--t4);font-size:var(--fs1);display:flex;gap:6px;align-items:center;cursor:pointer}
...
details.desc>summary,details.ev>summary{color:var(--t4);font-size:var(--fs1);display:flex;gap:6px;align-items:center}
details.ev{margin-top:5px}details.ev>summary{display:flex;gap:8px;align-items:center;min-width:0}
.evbtn{color:var(--t3);background:var(--s3);font-weight:500;flex:none}
.evbtn::before{content:"▸ ";font-size:9px;color:var(--t4)}details[open].ev .evbtn::before{content:"▾ "}
details.ev>summary:hover .evbtn{background:var(--line-strong)}
...
.diff summary{display:flex;gap:8px;align-items:center;color:var(--t3)}
...
.fcols>div{padding:8px 8px;font-size:var(--fs1);color:var(--t4);letter-spacing:.03em}
.frow{display:grid;grid-template-columns:44px 96px minmax(0,2.1fr) minmax(0,1.6fr) minmax(0,1.2fr);border-top:1px solid var(--line-soft);background:var(--s2)}
.frow.pend{background:#33262e}
...
.pending-hint{font-size:var(--fs2);color:#d98aa0;margin-top:4px}
